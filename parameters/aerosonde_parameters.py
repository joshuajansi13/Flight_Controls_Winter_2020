...
# Motor parameters
KV = 145.0                   # from datasheet RPM/V
KQ = (1.0 / KV) * 60.0 / (2.0 * np.pi)  # KQ in N-m/A, V-s/rad
R_motor = 0.042              # ohms
...
######################################################################################
                #   Trim States
######################################################################################
x_trim = np.array([[-9.23556832e-16],
                 [4.71290765e-15],
                 [-2.00000000e+01],
                 [2.49687427e+01],
                 [0.00000000e+00],
...
delta_e_star = -1.24778073e-01
delta_a_star = 1.83617600e-03
delta_r_star = -3.02606668e-04
delta_t_star = 6.76752115e-01

delta_a_max = np.radians(30)
